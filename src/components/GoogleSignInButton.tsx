...
export default function GoogleSignInButton({ mode = 'signin', callbackUrl }: GoogleSignInButtonProps) {
  ...
  const label = mode === 'signup' ? 'إنشاء حساب بـ Google' : 'تسجيل الدخول بـ Google';
