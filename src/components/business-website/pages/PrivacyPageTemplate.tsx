...
export function PrivacyPageTemplate({ business, page }: PageTemplateProps) {
  const content = page.content || `سياسة الخصوصية لموقع ${business.name}. نحن نحترم خصوصيتك ونحمي بياناتك.`;
